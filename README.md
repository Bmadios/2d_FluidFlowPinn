...
Acquiring data through numerical simulation to establish a reference solution to the problem.
Combining the understanding of physics with the learning prowess of neural networks to formulate a predictive model, which will then be evaluated using the acquired data.
